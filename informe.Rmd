...
y el sesgo (la diferencia entre ambos) para cada tamaño de muestra.
Observamos bajo sesgo, lo cual puede visualizarse en los gráficos arriba.
Destacamos que, como esperado, el sesgo disminuye a medida que aumenta el tamaño de la muestra.
...
c <- as.data.frame(cbind(a, b, bias = abs(mapply("-", a, b))))
c
```
