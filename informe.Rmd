...
TODO: comentar sobre al varianza
...
TODO: comentar sobre la varianza
...
Podemos observar en este caso que los intervalos de confianza empirico y asumiendo normalidad son muy similares para cualquier tamaño de muestra 
...
a <- show_results("Var(t_xo)", lapply(ber_t_xo_estimates, SE))
b <- show_results("Var(t_dist)", ber_t_xo_dist$standard_errors)
c <- as.data.frame(cbind(a, b, difference = abs(mapply("-", a, b))))
c
```
